...
"}")
        ...
        self.label_tip.setGeometry(QRect(20, 290, 300, 20))
        font3 = QFont()
...
"color:black;")
        ...
        self.label_title.setGeometry(QRect(1, 1, 338, 60))
...
"border-bottom-right-radius : 0px;")
        ...
        self.label_preview.setGeometry(QRect(20, 80, 300, 200))
        self.label_preview.setMinimumSize(QSize(0, 0))
        font5 = QFont()
        font5.setFamilies([u"Arial"])
        font5.setPointSize(10)
        font5.setBold(False)
        self.label_preview.setFont(font5)
        self.label_preview.setStyleSheet(u"color: rgb(0 ,0, 0);\n"
"background-color: #EAEFEF;\n"
"border: 1px solid black;")
        self.label_preview.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.reset_button = QPushButton(self.frame_main)
        self.reset_button.setObjectName(u"reset_button")
        self.reset_button.setGeometry(QRect(280, 240, 30, 30))
        self.reset_button.setMinimumSize(QSize(0, 0))
        self.reset_button.setMaximumSize(QSize(88, 16777215))
        font6 = QFont()
        font6.setFamilies([u"Arial"])
        font6.setPointSize(12)
        self.reset_button.setFont(font6)
...
"border-radius: 15px;")
        ...
        self.label_surface2.setGeometry(QRect(170, 320, 90, 70))
        ...
        self.label_surface2.setFont(font4)
...
"border-bottom-right-radius : 0px;")
        ...
        self.label_surface1.setGeometry(QRect(80, 320, 90, 70))
        ...
        self.label_surface1.setFont(font4)
...
"border-bottom-right-radius : 0px;")
        ...
        self.label_surface3.setGeometry(QRect(80, 390, 90, 70))
        ...
        self.label_surface3.setFont(font4)
...
"border-bottom-right-radius : 0px;")
        ...
        self.label_surface4.setGeometry(QRect(170, 390, 90, 70))
        ...
        self.label_surface4.setFont(font4)
...
"border-bottom-right-radius : 5px;")
    ...
    def retranslateUi(self, ImageWindow):
        ...
        self.label_title.setText(QCoreApplication.translate("ImageWindow", u"action name", None))
